...
export default function GiftPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center relative overflow-hidden">
      ...
      >
        I have something special for you, my Iqra... 💝
      </motion.h2>
              ...
              <AnimatePresence>
                {showSurprise && (
                  ...
                  >
                    ...
                    >
                      This flower will never ever wilt...🌹
                    </motion.p>
                    <motion.p
                      initial={{ opacity: 0, y: 15 }}
                      animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                      Just like my love for you. I promise to cherish you every single day wallah, and never take your
                      beautiful heart and trust for granted everrrrrrr again.💖
                    </motion.p>
                    <motion.p
                      initial={{ opacity: 0, y: 15 }}
                      animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                      You mean everything to me Wallah🥺✨
                    </motion.p>
                  </motion.div>
                )}
              </AnimatePresence>
